...
|-----------|-----|--------|----------|---------|
| Insert data | Vault | POST | `/v1/vaults/{id}/{table}` | [vault-api.md](vault-api.md) |
| Get by ID | Vault | GET | `/v1/vaults/{id}/{table}` | [vault-api.md](vault-api.md) |
| Detokenize | Vault | POST | `/v1/vaults/{id}/detokenize` | [vault-api.md](vault-api.md) |
| Update | Vault | PUT | `/v1/vaults/{id}/{table}` | [vault-api.md](vault-api.md) |
| Delete | Vault | DELETE | `/v1/vaults/{id}/{table}` | [vault-api.md](vault-api.md) |
| Query connection | Vault | POST | `/v1/vaults/{id}/connections/{conn}/query` | [vault-api.md](vault-api.md) |
...
- **[data.openapi.json](data.openapi.json)** - Vault Data API (insert, retrieve, update, delete)
...
1. **Identify the API** - Vault, Detect, or Management
2. **Link to the detailed doc** - vault-api.md, detect-api.md, or management-api.md
